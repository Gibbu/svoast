...
{#key settings.position}
	<Toasts position={settings.position} />
{/key}

<section class="h-[450px] flex justify-center items-center text-center bg-black border-b border-neutral-800 relative">
	<div
...
>
	<article
		...
		class={clsx(
			...
			'prose-pre:border',
			'prose-pre:border-neutral-800 prose-pre:relative',
